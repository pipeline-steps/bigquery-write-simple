import timeit
from google.cloud.bigquery.client import pandas
...
def main(step: StepArgs):
    ...
    pandas.to_gbq(df, step.config.tableId, project_id=step.config.tableId, if_exists=step.config.tableId.ifExists)
